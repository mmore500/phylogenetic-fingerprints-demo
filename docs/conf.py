...
# -*- coding: utf-8 -*-
#
# phylogenetic-fingerprints-demo documentation build configuration file, created by
...
project = u'Phylogenetic Fingerprints Demo'
copyright = u"2021, Matthew Andres Moreno"
...
htmlhelp_basename = 'phylogenetic-fingerprints-demodoc'
...
latex_documents = [
    (master_doc, 'phylogenetic-fingerprints-demo.tex',
     u'Phylogenetic Fingerprints Demo Documentation',
...
man_pages = [
    (master_doc, 'phylogenetic-fingerprints-demo',
     u'Phylogenetic Fingerprints Demo Documentation',
     [author], 1)
]
